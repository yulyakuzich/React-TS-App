...
var kf = (e, t, n) =>
  t in e
    ...
    : (e[t] = n);
var Qe = (e, t, n) => (kf(e, typeof t != 'symbol' ? t + '' : t, n), n);
(function () {
...
z.StrictMode = Nf;
z.Suspense = Lf;
z.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = If;
...
z.isValidElement = Ei;
z.lazy = function (e) {
  return { $$typeof: jf, _payload: { _status: -1, _result: e }, _init: Mf };
};
z.memo = function (e, t) {
      ...
      e: for (var K = 0, Z = C.length, hr = Z >>> 1; K < hr; ) {
        ...
        if (0 > l(Hl, L))
          Nt < Z && 0 > l(mr, Hl)
            ? ((C[K] = mr), (C[Nt] = L), (K = Nt))
            : ((C[K] = Hl), (C[_t] = L), (K = _t));
        else if (Nt < Z && 0 > l(mr, L)) (C[K] = mr), (C[Nt] = L), (K = Nt);
        else break e;
      }
    }
    return T;
  ...
  function x(C, T) {
    ...
    try {
      ...
      if (h !== null) var hr = !0;
        ...
        var _t = n(a);
        _t !== null && $l(w, _t.startTime - T), (hr = !1);
      }
      return hr;
    } finally {
      (h = null), (m = L), (E = !1);
      ...
      return (
        ...
        L > K
          ? ((C.sortIndex = L),
            ...
            n(s) === null &&
              C === n(a) &&
              (g ? (d(P), (P = -1)) : (g = !0), $l(w, L - K)))
          : ((C.sortIndex = Z), t(s, C), y || E || ((y = !0), Bl(x))),
        C
      );
    }),
...
function un(e, t) {
  for (Vn[e] = t, e = 0; e < t.length; e++) ea.add(t[e]);
}
var Ze = !(
    typeof window > 'u' ||
...
function ld(e, t, n, r, l, o, i, u, s) {
  (Fn = !1), (Yr = null), nd.apply(rd, arguments);
}
...
function ga(e) {
  return (e = id(e)), e !== null ? wa(e) : null;
}
function wa(e) {
...
function Xn(e) {
  ...
  for (; 0 < st.length && ((n = st[0]), n.blockedOn === null); )
    Ta(n), n.blockedOn === null && st.shift();
}
...
function zi(e, t, n, r) {
  if (br) {
    ...
    else if ((zu(e, r), t & 4 && -1 < gd.indexOf(e))) {
      for (; l !== null; ) {
        var o = cr(l);
        if (
          (o !== null && _a(o),
...
var yn = {
  ...
  ql = ke(Nd),
  Pd = V({}, yn, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Rd = ke(Pd),
  Td = V({}, yn, {
...
var Ad = V({}, ar, {
  ...
  Bd = ke(Ud),
  $d = V({}, yn, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Hd = ke($d),
  Vd = V({}, El, {
    deltaX: function (e) {
...
var Kd = Ze && 'TextEvent' in window && !An,
  za = Ze && (!Ai || (An && 8 < An && 11 >= An)),
...
function Xd(e, t) {
  if (Wt)
    return e === 'compositionend' || (!Ai && ja(e, t))
      ? ((e = La()), (Ar = ji = ct = null), (Wt = !1), e)
      : null;
  switch (e) {
    case 'paste':
      return null;
...
if (Ze) {
  ...
  Aa = Zl && (!document.documentMode || 9 < document.documentMode);
}
function Hu() {
  Mn && (Mn.detachEvent('onpropertychange', Ma), (Yn = Mn = null));
}
function Ma(e) {
  if (e.propertyName === 'value' && kl(Yn)) {
    var t = [];
    Fa(t, Yn, e, Ri(e)), ya(Gd, t);
  }
}
function Zd(e, t, n) {
  e === 'focusin'
    ? (Hu(), (Mn = t), (Yn = n), Mn.attachEvent('onpropertychange', Ma))
    : e === 'focusout' && Hu();
}
function bd(e) {
...
function xl(e) {
  ...
  var t = Kt[e],
    n;
  for (n in t) if (t.hasOwnProperty(n) && n in Ba) return (eo[e] = t[n]);
  return e;
}
...
for (var to = 0; to < Ku.length; to++) {
  var no = Ku[to],
    op = no.toLowerCase(),
    ip = no[0].toUpperCase() + no.slice(1);
  kt(op, 'on' + ip);
}
kt($a, 'onAnimationEnd');
...
var jn =
  ...
  up = new Set('cancel close invalid load scroll toggle'.split(' ').concat(jn));
function Ju(e, t, n) {
...
function Ka(e, t) {
  ...
  if (Gr) throw ((e = Ao), (Gr = !1), (Ao = null), e);
}
function I(e, t) {
  var n = t[Ko];
  ...
  if (!e[_r]) {
    (e[_r] = !0),
      ea.forEach(function (n) {
        n !== 'selectionchange' && (up.has(n) || ro(n, !1, e), ro(n, !0, e));
      });
        ...
        for (var c = a, p; c !== null; ) {
          ...
          if (
            (p.tag === 5 &&
              w !== null &&
              ((p = w),
              d !== null && ((w = Qn(c, d)), w != null && g.push(Zn(c, w, p)))),
            O)
          )
            break;
          c = c.return;
      ...
      P &&
        (za &&
          ...
          (Wt || P !== 'onCompositionStart'
            ? P === 'onCompositionEnd' && Wt && (N = La())
            : ((ct = f),
              (ji = 'value' in ct ? ct.value : ct.textContent),
              (Wt = !0))),
        (_ = tl(a, P)),
        0 < _.length &&
          ((P = new Au(P, e, null, n, f)),
...
function Ct() {
  if (!io && Je !== null) {
    ...
    try {
      ...
      throw (Je !== null && (Je = Je.slice(e + 1)), Sa(Ti, Ct), l);
    } finally {
      (A = t), (io = !1);
    }
  }
...
function Ga(e, t, n) {
  (xe[Ce++] = Xe), (xe[Ce++] = Ye), (xe[Ce++] = Ft), (Ft = e);
  var r = Xe;
  e = Ye;
  var l = 32 - Fe(r) - 1;
  (r &= ~(1 << l)), (n += 1);
...
function Zo(e, t, n, r) {
  var l = e.stateNode;
  (l.props = n), (l.state = e.memoizedState), (l.refs = tc), Qi(e);
  var o = t.contextType;
  typeof o == 'object' && o !== null
    ? (l.context = Re(o))
    : ((o = me(t) ? Dt : ue.current), (l.context = sn(e, o))),
...
function rc(e) {
  ...
  function f(d, c, p, w, x) {
    return c === null || c.tag !== 7
      ? ((c = jt(p, d.mode, w, x)), (c.return = d), c)
      : ((c = l(c, p)), (c.return = d), c);
  }
  function h(d, c, p) {
  ...
  function m(d, c, p, w) {
    ...
    if (typeof p == 'object' && p !== null) {
      ...
      if (Ln(p) || En(p)) return x !== null ? null : f(d, c, p, w, null);
      Rr(d, p);
    }
    return null;
  }
  function E(d, c, p, w, x) {
    ...
    if (typeof w == 'object' && w !== null) {
      ...
      if (Ln(w) || En(w)) return (d = d.get(p) || null), f(c, d, w, x, null);
      Rr(c, w);
    }
    return null;
  }
  ...
  function g(d, c, p, w) {
    ...
    for (
      var _ = (x = null), N = c, P = (c = 0), Q = null, j = p.next();
      N !== null && !j.done;
      P++, j = p.next()
    ) {
      N.index > P ? ((Q = N), (N = null)) : (Q = N.sibling);
      var Oe = m(d, N, j.value, w);
      if (Oe === null) {
        N === null && (N = Q);
        break;
      }
    ...
    if (N === null) {
      for (; !j.done; P++, j = p.next())
        (j = h(d, j.value, w)),
          j !== null &&
            ((c = o(j, c, P)), _ === null ? (x = j) : (_.sibling = j), (_ = j));
      return B && Pt(d, P), x;
    }
      ...
      switch (p.$$typeof) {
        case vr:
          e: {
            ...
            p.type === Vt
              ? ((c = jt(p.props.children, d.mode, w, p.key)),
                (c.return = d),
                (d = c))
              : ((w = Wr(p.type, p.key, p.props, null, d.mode, w)),
                (w.ref = Nn(d, c, p)),
...
function Gi(e, t, n, r, l, o) {
  if (
    ...
    (t.updateQueue = null),
    (t.lanes = 0),
    (Ur.current = e === null || e.memoizedState === null ? Ep : kp),
    (e = n(r, l)),
    Un)
  ) {
    o = 0;
...
function uc(e, t) {
  ...
  if (
    ...
    (r = r.queue),
    Zi(cc.bind(null, n, r, e), [e]),
    r.getSnapshot !== t || o || (b !== null && b.memoizedState.tag & 1))
  ) {
    if (
      ((n.flags |= 2048),
      lr(9, ac.bind(null, n, r, l, t), void 0, null),
      ee === null)
    )
      throw Error(S(349));
    At & 30 || sc(n, t, l);
...
function Sc(e, t, n) {
  return At & 21
    ? (Me(n, t) || ((n = xa()), (H.lanes |= n), (Mt |= n), (e.baseState = !0)),
      t)
...
var dl = {
  ...
  Ep = {
    ...
    useSyncExternalStore: function (e, t, n) {
      ...
      return (
        (l.queue = o),
        ss(cc.bind(null, r, o, e), [e]),
        (r.flags |= 2048),
        lr(9, ac.bind(null, r, o, n, t), void 0, null),
        n
      );
    },
    useId: function () {
...
function ti(e, t, n, r, l, o) {
  Tc(e, t);
  var i = (t.flags & 128) !== 0;
  if (!r && !i) return l && bu(t, n, !1), tt(e, t, o);
...
function Np(e, t, n, r, l, o, i) {
  ...
  if (((u = (i & e.childLanes) !== 0), pe || u)) {
    ...
    return iu(), (r = fo(Error(S(421)))), Tr(e, t, i, r);
  }
  return l.data === '$?'
    ? ((t.flags |= 128),
      (t.child = e.child),
...
function Ac(e) {
  ...
  t !== null && ((e.alternate = null), Ac(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[Be], delete t[bn], delete t[Ko], delete t[pp], delete t[hp])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Ae(e, t, n, r) {
  ...
  sr(e, n, r),
    (!(F & 2) || e !== ee) &&
      (e === ee && (!(F & 2) && (Tl |= n), q === 4 && at(e, ne)),
      ye(e, r),
      n === 1 && F === 0 && !(t.mode & 1) && ((pn = J() + 500), _l && Ct()));
}
function ye(e, t) {
  ...
  if (r === 0)
    ...
    if ((n != null && Lu(n), t === 1))
      e.tag === 0 ? mp(xs.bind(null, e)) : Ya(xs.bind(null, e)),
        fp(function () {
          !(F & 6) && Ct();
        }),
        (n = null);
...
function $c(e, t) {
  ...
  if (r & 30 || r & e.expiredLanes || t) t = yl(e, r);
    ...
    F |= 2;
    var o = Vc();
    (ee !== e || ne !== t) && ((Ke = null), (pn = J() + 500), zt(e, t));
    do
      try {
        Ap();
        break;
  ...
  if (t !== 0) {
    if (
      ...
      throw ((n = or), zt(e, 0), at(e, r), ye(e, J()), n);
    if (t === 6) at(e, r);
    else {
      if (
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), t)) {
        ...
        case 3:
          if (
            (at(e, r), (r & 130023424) === r && ((t = ru + 500 - J()), 10 < t))
          ) {
            if (Zr(e, 0) !== 0) break;
...
function xs(e) {
  ...
  if (n === 1) throw ((n = or), zt(e, 0), at(e, t), ye(e, J()), n);
...
function It(e) {
  ...
  try {
    ...
    (A = r), (Ne.transition = n), (F = t), !(F & 6) && Ct();
  }
}
function ou() {
  (ve = bt.current), U(bt);
...
function iu() {
  (q === 0 || q === 3 || q === 2) && (q = 4),
    ee === null || (!(Mt & 268435455) && !(Tl & 268435455)) || at(ee, ne);
}
function yl(e, t) {
  var n = F;
  F |= 2;
  ...
  while (1);
  if ((Hi(), (F = n), (pl.current = r), X !== null)) throw Error(S(261));
...
function Rt(e, t, n) {
  var r = A,
    l = Ne.transition;
  try {
    (Ne.transition = null), (A = 1), Mp(e, t, n, r);
  } finally {
    (Ne.transition = l), (A = r);
  }
  return null;
  ...
  if (ft !== null) {
    ...
    try {
      if (((Ne.transition = null), (A = 16 > e ? 16 : e), ft === null))
        ...
        if (((e = ft), (ft = null), (ml = 0), F & 6)) throw Error(S(331));
        var l = F;
        ...
        if (
          ((F = l), Ct(), He && typeof He.onPostCommitFiberRoot == 'function')
        )
          try {
  ...
  switch (e.tag) {
    case 3:
      ...
      if (t.current.memoizedState.isDehydrated) {
        ...
        n !== 0 &&
          (Oi(t, n | 1), ye(t, J()), !(F & 6) && ((pn = J() + 500), Ct()));
      }
      break;
    case 13:
      It(function () {
...
ha = lu;
ma = It;
var Jp = { usingClientEntryPoint: !1, Events: [cr, Jt, Cl, da, pa, lu] },
  Rn = {
...
const ah = (e, t, n, { allOwnKeys: r } = {}) => (
  ...
  Ts = '0123456789',
  uf = { DIGIT: Ts, ALPHA: yo, ALPHA_DIGIT: yo + yo.toUpperCase() + Ts },
  _h = (e = 16, t = uf.ALPHA_DIGIT) => {
    let n = '';
    const { length: r } = t;
...
const Ph = (e) => {
  ...
  Rh = We('AsyncFunction'),
  Th = (e) => e && (Ml(e) || Pe(e)) && Pe(e.then) && Pe(e.catch),
  v = {
    isArray: gn,
    isArrayBuffer: ef,
    isBuffer: qp,
...
function Il(e, t, n) {
  ...
  function f(y, g, O) {
    ...
    return hi(y) ? !0 : (t.append(Os(O, g, o), a(y)), !1);
  }
  const h = [],
    m = Object.assign(zh, {
      defaultVisitor: f,
...
const zs = Dh,
  ...
  Fh = typeof URLSearchParams < 'u' ? URLSearchParams : pu,
  ...
  $e = {
    isBrowser: !0,
    classes: { URLSearchParams: Fh, FormData: Ah, Blob: Mh },
  ...
  lm =
    ...
    function (e) {
      return new Promise(function (n, r) {
        ...
        const h = yf(e.baseURL, e.url);
        f.open(e.method.toUpperCase(), df(h, e.params, e.paramsSerializer), !0),
          (f.timeout = e.timeout);
        function m() {
          if (!f) return;
          const y = qe.from(
        ...
        if (
          ...
          const y = em(h) && e.xsrfCookieName && qh.read(e.xsrfCookieName);
        ...
        l === void 0 && o.setContentType(null),
          ...
          typeof e.onDownloadProgress == 'function' &&
            f.addEventListener('progress', Ds(e.onDownloadProgress, !0)),
          typeof e.onUploadProgress == 'function' &&
            f.upload &&
            f.upload.addEventListener('progress', Ds(e.onUploadProgress)),
...
Y.mergeConfig = hn;
Y.AxiosHeaders = qe;
Y.formToJSON = (e) => hf(v.isHTMLForm(e) ? new FormData(e) : e);
Y.getAdapter = vf.getAdapter;
Y.HttpStatusCode = cm;
Y.default = Y;
const fm = Y,
  dm = 'https://swapi.dev/api/',
  Us = (e) => fm.get(dm + 'people/' + (e ? `?search=${e}` : ''));
class pm extends nt.Component {
  constructor() {
    super(...arguments);
    Qe(this, 'state', { hasError: !1 });
  }
  static getDerivedStateFromError() {
    return { hasError: !0 };
  }
  componentDidCatch(n, r) {
    console.error(n, r.componentStack);
  }
  render() {
  ...
  render() {
    return R.jsx('section', {
      children: R.jsx('div', {
        ...
        children: R.jsxs('div', {
          className: 'ring',
          children: ['Loading', R.jsx('span', { className: 'circle' })],
        }),
      }),
    });
  }
}
class ym extends nt.Component {
  render() {
    return R.jsx('section', {
      children: R.jsx('div', {
        className: 'container',
        children: R.jsx('div', {
          className: 'characters_list',
          children: this.props.results.map((t) =>
            R.jsxs(
              'div',
              {
                className: 'characters_list_item column',
                children: [
                  R.jsx('div', {
                    className: 'characters_list_item_avatar',
                    children: R.jsx('img', { src: 'star-wars.svg', alt: '' }),
                  }),
                  R.jsx('p', {
                    className: 'characters_list_item_name',
                    children: t.name,
                  }),
                  R.jsxs('p', {
                  ...
                  R.jsxs('p', {
                    className: 'character_detail',
                    children: [
                      R.jsx('strong', { children: 'Skin color:' }),
                      ' ',
                      t.skin_color,
                    ],
                  }),
...
class vm extends nt.Component {
  constructor() {
    super(...arguments);
    Qe(this, 'state', { request: this.props.value });
    Qe(this, 'handleRequestChange', (n) => {
      this.setState({ request: n.target.value });
    });
    Qe(this, 'handleSubmit', (n) => {
      n.preventDefault(), this.props.onSearch(this.state.request);
    });
  }
  render() {
...
class gm extends nt.Component {
  constructor() {
    ...
    Qe(this, 'handleSearch', (n) => {
      localStorage.setItem('search', n),
        console.log(n),
        this.setState({ loading: !0 }),
        Us(n).then((r) => {
          console.log(r.data),
            this.setState({ results: r.data.results, loading: !1 });
        });
    });
  }
  componentDidMount() {
    const n = localStorage.getItem('search');
    this.setState({ loading: !0 }),
      Us(n || '').then((r) => {
        console.log(r.data),
          this.setState({ results: r.data.results, loading: !1 });
      ...
      children: R.jsx(pm, {
        children: R.jsxs(R.Fragment, {
          children: [
            ...
            this.state.loading
              ? R.jsx(mm, {})
              : R.jsx(ym, { results: this.state.results }),
            R.jsx(hm, {}),
          ],
        }),
      }),
...
So.createRoot(document.getElementById('root')).render(
  R.jsx(Uf.StrictMode, { children: R.jsx(gm, {}) })
);
